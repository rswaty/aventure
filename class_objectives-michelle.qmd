...
-   senior thesis N and P on waterways by mangroves

-   data from 1986. is there a correlation between land use change and nutrients in water

-   used GIS to map mangrove to uban

-   learn the lubridate package

-   set up zoom with Randy
