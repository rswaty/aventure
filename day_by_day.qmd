...
1.  Welcome and answer questions (end at 8:40)
2.  Review some of the lessons of Chapter 1 of https://swcarpentry.github.io/r-novice-gapminder/index.html
    1.  What is a vector?
    2.  ls section! Note that if we run 'ls' alone we get all of the code that makes the function 'ls'
    3.  What is a package? Try to install chorddiag. Show <http://www.sthda.com/english/wiki/installing-and-using-r-packages>
3.  Continue meetings

**Homework**:

-   <https://datacarpentry.org/R-ecology-lesson/01-intro-to-r.html#vectors-and-data-types> and <http://www.sthda.com/english/wiki/installing-and-using-r-packages> DO in your 'reproducible_analysis' repo

-   show me your directory

-   add a chart to your r_examples repo
